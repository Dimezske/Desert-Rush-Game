...
import Bullet from './game/Guns/p90';
import BulletImg from './assets/p90_bullets.png';
/**
...
class GameScene extends Phaser.Scene
{
 ...
 init(){
    ...
    create (data) {
        ...
        //-------------Guns----------------------------------
        this.p90 = this.physics.add.existing(new P90(this, this.player.x, this.player.y, 'p90-sprite', 0))
	...
	update(time, delta) {
        ...
        {  
            ...
            this.player.y=-10000; this.player.body.setEnable(false);this.player.visible=false;
            this.input.keyboard.once('keydown-SPACE', () => {
                gameover.visible = false;
                this.player.visible=true;
                this.player.body.setEnable(true);    
                this.player.setPosition(this.player.respawnPoint.x,this.player.respawnPoint.y);
