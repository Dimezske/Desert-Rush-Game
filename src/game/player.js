...
export default class Player extends Phaser.Physics.Arcade.Sprite {
  constructor(scene, x, y, key, frame) {
    ...
    this.keys = {
      ...
      clingOn: this.scene.input.keyboard.addKey(
        Phaser.Input.Keyboard.KeyCodes.W
      ),
      clingOff: this.scene.input.keyboard.addKey(
      ...
      duck2: this.scene.input.keyboard.addKey(
  ...
  control_handler() {
    ...
    if (this.cursors.up.isDown && this.body.touching.down || this.keys["jump2"].isDown && this.body.touching.down) {
